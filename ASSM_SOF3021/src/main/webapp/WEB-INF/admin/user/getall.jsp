...
<div class="row">
    <form:form method="post" action="/admin/user/getall">
        <div class="mb-3">
            <label for="" class="form-label">Họ Và Tên:</label>
            <select class="form-control" name="role" id="" >
                <option value="all">Tất Cả</option>
                <c:forEach items="${listrole}" var="xx">
                    <option value="${xx}">
                        ${xx}
                    </option>
                </c:forEach>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="usName" id="" class="form-control" placeholder=""
...
<form:form method="post" action="/admin/user/deleteclick">
        ...
        <c:forEach items="${ page.getContent()}" var="xy">
            ...
            <tr>
                <div class="modal fade" id="example${xy.id}" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Cập Nhâp User</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form:form action="/admin/user/update?id=${xy.id}" method="post">
                                    <div class="mb-3">
                                        <label for="" class="form-label">User Name:</label>
                                        <input type="text" name="userName" id="" class="form-control" placeholder=""
                                               value="${xy.userName}" aria-describedby="helpId">

                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Email:</label>
                                        <input type="text" name="email" id="" class="form-control" placeholder=""
                                               value="${xy.email}" aria-describedby="helpId">

                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">SĐT:</label>
                                        <input type="text" name="sdt" id="" class="form-control" placeholder=""
                                               value="${xy.sdt}" aria-describedby="helpId">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="role" id="">
                                            <c:forEach items="${listrole}" var="xx">
                                                <option value="${xx}"
                                                        <c:if test="${xx==xy.role}">selected</c:if> >
                                                        <%-- ${value}--%>
                                                    ${xx}
                                                </option>
                                            </c:forEach>
            ...
            <div class="modal fade" id="exampleModal${xy.id}" tabindex="-1" aria-labelledby="exampleModalLabel${xy.id}"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel${xy.id}">Xóa User</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        </div>
                        <div class="modal-footer">
                            ...
                            <a href="/admin/user/delete?id=${xy.id}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form:form action="/admin/user/add" method="post">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Pass Word:</label>
                        <input type="text" name="pw" id="" class="form-control" placeholder=""
                               aria-describedby="helpId">
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-end">
        <li class="page-item <c:if test="${page.getNumber() < 1 }">disabled</c:if> ">
            ...
            <a class="page-link" href="/admin/user/getall?pageNumber=${page.getNumber() - 1}"> < </a>
