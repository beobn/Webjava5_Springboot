...
<div style="margin-left: 30%;float: left;">
    <form:form method="post" action="/pay/bill?amountt=${pricebill}&id=${bill.id}&quantity=${quantity}">

        <b>Tên Thẻ:</b> <p>${bill.name}</p>

        <br>
        <b>Số Lượng:</b> <p>${quantity}</p>

        <br>
        <b>Email nhận thẻ:</b> <p>${bill.emailSend}</p>

        <br>
        <b>Tổng Tiền Phải Thanh Toán:</b> <p>${pricebill} VNĐ</p>

        <b>Viết Bằng Chữ:</b> <p>${stringPrice}</p>
