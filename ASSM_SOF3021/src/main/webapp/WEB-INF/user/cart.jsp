...
<div class="text-center">
    ...
    <table class="table table-striped">
        ...
        <button type="submit" class="btn btn-danger"> Thanh Toán Hàng Loạt</button>
        <c:forEach items="${list}" var="xy">
            <form:form method="post" action="/user/cartbill?price=${xy.price}&id=${xy.id}">
                <tr>
                    ...
                    <td>${xy.emailSend }</td>
                    <td>
                        <c:if test="${xy.idUser==null }">Khách</c:if>
                        <c:if test="${xy.idUser!=null}">${xy.idUser }</c:if>
                    </td>
                    <td>
                        <div class="mb-3">

                            <input type="number" name="quantity" min="1" max="${xy.slcon}" id="" class="form-control"
                                   placeholder=""
                                   aria-describedby="helpId" value="${xy.quantity}">
                    ...
                    <td>
                        <button type="submit" class="btn btn-warning">Xác Nhận Thanh Toán</button>
                    </td>
            ...
            <div class="modal fade" id="exampleModal${xy.id}" tabindex="-1" aria-labelledby="exampleModalLabel${xy.id}"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel${xy.id}">Xóa Cart</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        </div>
                        <div class="modal-footer">
                            ...
                            <a href="/user/deletecart?id=${xy.id}">
